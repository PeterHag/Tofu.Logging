...
{
    public class LogMonitorMemoryVirtualMemorySize : LogMonitorProcess
    {
        #region Constructors
        ...
        /// Constructor
        /// </summary>
        public LogMonitorMemoryVirtualMemorySize() : base()
        { }
        ...
        protected override void OnResolveParameters(out string memoryParameterName)
        {
            ...
            memoryParameterName = MEMORY_VIRTUALMEMORYSIZE;
        }
