...
{
    public class LogMonitorMemoryPrivateMemorySize : LogMonitorProcess
    {
        #region Constructors
        ...
        /// Constructor
        /// </summary>
        public LogMonitorMemoryPrivateMemorySize() : base()
        { }
        ...
        protected override void OnResolveParameters(out string memoryParameterName)
        {
            ...
            memoryParameterName = MEMORY_PRIVATEMEMORYSIZE;
        }
