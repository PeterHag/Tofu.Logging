...
{
    public class LogMonitorMemoryPagedSystemMemorySize : LogMonitorProcess
    {
        #region Constructors
        ...
        /// Constructor
        /// </summary>
        public LogMonitorMemoryPagedSystemMemorySize() : base()
        { }
        ...
        protected override void OnResolveParameters(out string memoryParameterName)
        {
            ...
            memoryParameterName = MEMORY_PAGEDSYSTEMMEMORYSIZE;
        }
