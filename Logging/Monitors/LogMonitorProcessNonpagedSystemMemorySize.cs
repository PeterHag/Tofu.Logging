...
{
    public class LogMonitorMemoryNonpagedSystemMemorySize : LogMonitorProcess
    {
        #region Constructors
        ...
        /// Constructor
        /// </summary>
        public LogMonitorMemoryNonpagedSystemMemorySize() : base()
        { }
        ...
        protected override void OnResolveParameters(out string memoryParameterName)
        {
            ...
            memoryParameterName = MEMORY_NONPAGEDSYSTEMMEMORYSIZE;
        }
